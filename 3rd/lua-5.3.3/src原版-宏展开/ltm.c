...
const TValue *luaT_gettmbyobj(lua_State *L, const TValue *o, TMS event) {
	...
	return (mt ? luaH_getshortstr(mt, (L->l_G)->tmname[event]) : (&luaO_nilobject_));
}

const char *luaT_objtypename(lua_State *L, const TValue *o) {
	Table *mt;
	if ((((((o))->tt_) == (((5) | (1 << 6)))) && (mt = ((&((((union GCUnion *)((((o)->value_).gc))))->h)))->metatable) != ((void *)0)) ||
		(((((o))->tt_) == (((7) | (1 << 6)))) && (mt = ((&((((union GCUnion *)((((o)->value_).gc))))->u)))->metatable) != ((void *)0))) {
		const TValue *name = luaH_getshortstr(mt, luaS_new(L, "__name"));
		if ((((((((name))->tt_)) & 0x0F)) == (4)))
			return (((char *)((((&((((union GCUnion *)((((name)->value_).gc))))->ts)))))) + sizeof(UTString));
	}
...
void luaT_trybinTM(lua_State *L, const TValue *p1, const TValue *p2,
	...
	if (!luaT_callbinTM(L, p1, p2, res, event)) {
		...
		case TM_SHL: case TM_SHR: case TM_BNOT: {
			lua_Number dummy;
			if ((((((p1))->tt_) == ((3 | (0 << 4)))) ? (*(&dummy) = (((p1)->value_).n), 1) : luaV_tonumber_(p1, &dummy)) && (((((p2))->tt_) == ((3 | (0 << 4)))) ? (*(&dummy) = (((p2)->value_).n), 1) : luaV_tonumber_(p2, &dummy)))
